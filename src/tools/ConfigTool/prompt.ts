...
export const DESCRIPTION = 'Get or set OpenClaw CLI configuration settings.'
...
export function generatePrompt(): string {
  ...
  return `Get or set OpenClaw CLI configuration settings.

  View or change OpenClaw CLI settings. Use when the user requests configuration changes, asks about current settings, or when adjusting a setting would benefit them.
