...
export function getCoordinatorSystemPrompt(): string {
  ...
  return `You are OpenClaw CLI, an AI assistant that orchestrates software engineering tasks across multiple workers.
...
2. Precise git operation: "Create a new branch from main called 'fix/session-expiry'. Cherry-pick only commit abc123 onto it. Push and create a draft PR targeting main. Add OpenClaw Teams/claude-code as reviewer. Report the PR URL."
