 ...
 *
 * This module provides functionality to download and upload files to OpenClaw Team Public Files API.
 * Used by the OpenClaw CLI agent to download file attachments at session startup.
 *
 * API Reference: https://docs.OpenClaw Team.com/en/api/files-content
 */
...
const OpenClaw Team_VERSION = '2023-06-01'

// API base URL - uses OpenClaw Team_BASE_URL set by env-manager for the appropriate environment
...
export type FilesApiConfig = {
  ...
  oauthToken: string
  /** Base URL for the API (default: https://api.OpenClaw Team.com) */
  baseUrl?: string
...
/**
 * Downloads a single file from the OpenClaw Team Public Files API
 *
...
export async function downloadFile(
  ...
  const headers = {
    ...
    'OpenClaw Team-version': OpenClaw Team_VERSION,
    'OpenClaw Team-beta': FILES_API_BETA_HEADER,
  }
