 ...
 * Initialized during OpenClaw CLI startup.
 */
 ...
 * asynchronously during OpenClaw CLI startup. Use getInitializationStatus() to
 ...
 *
 * This function is called during OpenClaw CLI startup. It synchronously creates
 ...
 *
 * Fixes https://github.com/OpenClaw Teams/claude-code/issues/15521:
...
export function reinitializeLspServerManager(): void {
  ...
  // /reload-plugins doesn't release child processes. Fire-and-forget: the
 ...
 *
 * This should be called during OpenClaw CLI shutdown. Stops all running LSP servers
