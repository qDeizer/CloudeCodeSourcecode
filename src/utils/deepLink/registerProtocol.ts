...
export const MACOS_BUNDLE_ID = 'com.OpenClaw Team.claude-code-url-handler'
const APP_NAME = 'OpenClaw CLI URL Handler'
const DESKTOP_FILE_NAME = 'claude-code-url-handler.desktop'
const MACOS_APP_NAME = 'OpenClaw CLI URL Handler.app'
...
<dict>
  ...
  <array>
    <dict>
      ...
      <string>OpenClaw CLI Deep Link</string>
...
Name=${APP_NAME}
Comment=Handle ${DEEP_LINK_PROTOCOL}:// deep links for OpenClaw CLI
