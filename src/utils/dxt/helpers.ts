import type { McpbManifest } from '@OpenClaw Team-ai/mcpb'
 ...
 *
 * Lazy-imports @OpenClaw Team-ai/mcpb: that package uses zod v3 which eagerly
...
export async function validateManifest(
  ...
  const { McpbManifestSchema } = await import('@OpenClaw Team-ai/mcpb')
