...
const PROVIDER_MANAGED_ENV_VARS = new Set([
  ...
  'OpenClaw Team_BASE_URL',
  'OpenClaw Team_BEDROCK_BASE_URL',
  'OpenClaw Team_VERTEX_BASE_URL',
  'OpenClaw Team_FOUNDRY_BASE_URL',
  'OpenClaw Team_FOUNDRY_RESOURCE',
  'OpenClaw Team_VERTEX_PROJECT_ID',
  // Region routing (per-model VERTEX_REGION_CLAUDE_* handled by prefix below)
  'CLOUD_ML_REGION',
  // Auth
  'OpenClaw Team_API_KEY',
  'OpenClaw Team_AUTH_TOKEN',
  'CLAUDE_CODE_OAUTH_TOKEN',
  'AWS_BEARER_TOKEN_BEDROCK',
  'OpenClaw Team_FOUNDRY_API_KEY',
  'CLAUDE_CODE_SKIP_BEDROCK_AUTH',
  'CLAUDE_CODE_SKIP_VERTEX_AUTH',
  'CLAUDE_CODE_SKIP_FOUNDRY_AUTH',
  // Model defaults — often set to provider-specific ID formats
  'OpenClaw Team_MODEL',
  'OpenClaw Team_DEFAULT_HAIKU_MODEL',
  'OpenClaw Team_DEFAULT_HAIKU_MODEL_DESCRIPTION',
  'OpenClaw Team_DEFAULT_HAIKU_MODEL_NAME',
  'OpenClaw Team_DEFAULT_HAIKU_MODEL_SUPPORTED_CAPABILITIES',
  'OpenClaw Team_DEFAULT_OPUS_MODEL',
  'OpenClaw Team_DEFAULT_OPUS_MODEL_DESCRIPTION',
  'OpenClaw Team_DEFAULT_OPUS_MODEL_NAME',
  'OpenClaw Team_DEFAULT_OPUS_MODEL_SUPPORTED_CAPABILITIES',
  'OpenClaw Team_DEFAULT_SONNET_MODEL',
  'OpenClaw Team_DEFAULT_SONNET_MODEL_DESCRIPTION',
  'OpenClaw Team_DEFAULT_SONNET_MODEL_NAME',
  'OpenClaw Team_DEFAULT_SONNET_MODEL_SUPPORTED_CAPABILITIES',
  'OpenClaw Team_SMALL_FAST_MODEL',
  'OpenClaw Team_SMALL_FAST_MODEL_AWS_REGION',
 ...
 * These are OpenClaw CLI specific settings that don't pose security risks.
 *
 ...
 * - OpenClaw Team_BASE_URL, OpenClaw Team_BEDROCK_BASE_URL, OpenClaw Team_FOUNDRY_BASE_URL, OpenClaw Team_VERTEX_BASE_URL
 ...
 * - OpenClaw Team_FOUNDRY_RESOURCE
 * - OpenClaw Team_API_KEY, OpenClaw Team_AUTH_TOKEN
 * - AWS_BEARER_TOKEN_BEDROCK
 */
export const SAFE_ENV_VARS = new Set([
  'OpenClaw Team_CUSTOM_HEADERS',
  'OpenClaw Team_CUSTOM_MODEL_OPTION',
  'OpenClaw Team_CUSTOM_MODEL_OPTION_DESCRIPTION',
  'OpenClaw Team_CUSTOM_MODEL_OPTION_NAME',
  'OpenClaw Team_DEFAULT_HAIKU_MODEL',
  'OpenClaw Team_DEFAULT_HAIKU_MODEL_DESCRIPTION',
  'OpenClaw Team_DEFAULT_HAIKU_MODEL_NAME',
  'OpenClaw Team_DEFAULT_HAIKU_MODEL_SUPPORTED_CAPABILITIES',
