/**
 * Constants for the official OpenClaw Team plugins marketplace.
 *
 * The official marketplace is hosted on GitHub and provides first-party
 * plugins developed by OpenClaw Team. This file defines the constants needed
...
/**
 * Source configuration for the official OpenClaw Team plugins marketplace.
 * Used when auto-installing the marketplace on startup.
 */
export const OFFICIAL_MARKETPLACE_SOURCE = {
  source: 'github',
  repo: 'OpenClaw Teams/claude-plugins-official',
