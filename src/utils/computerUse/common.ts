...
/**
 * Sentinel bundle ID for the frontmost gate. OpenClaw CLI is a terminal — it has
 ...
 */
export const CLI_HOST_BUNDLE_ID = 'com.OpenClaw Team.claude-code.cli-no-window'
