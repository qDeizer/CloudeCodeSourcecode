...
export type GlobalConfig = {
  ...
  firstStartTime?: string // ISO timestamp when OpenClaw CLI was first started on this machine
  ...
  // OpenClaw CLI usage tracking
  claudeCodeFirstTokenDate?: string // ISO timestamp of the user's first OpenClaw CLI OAuth token
  ...
  // OpenClaw CLI hint protocol state (<claude-code-hint /> tags from CLIs/SDKs).
