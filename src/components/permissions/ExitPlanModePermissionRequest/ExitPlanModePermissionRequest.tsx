...
import type { Base64ImageSource, ImageBlockParam } from '@OpenClaw Team-ai/sdk/resources/messages.mjs';
...
export function buildPlanApprovalOptions({
  ...
  if (showUltraplan) {
    options.push({
      label: 'No, refine with Ultraplan on OpenClaw CLI on the web',
      value: 'ultraplan'
    });
  }
  options.push({
