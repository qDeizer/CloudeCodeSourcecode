...
const WORKFLOWS: WorkflowOption[] = [{
  ...
  label: '@OpenClaw CLI - Tag @claude in issues and PR comments'
}, {
  value: 'claude-review' as const,
  label: 'OpenClaw CLI Review - Automated code review on new PRs'
}];
...
export function WorkflowMultiselectDialog(t0) {
  ...
  if ($[4] === Symbol.for("react.memo_cache_sentinel")) {
    t4 = <Box><Text dimColor={true}>More workflow examples (issue triage, CI fixes, etc.) at:{" "}<Link url="https://github.com/OpenClaw Teams/claude-code-action/blob/main/examples/">https://github.com/OpenClaw Teams/claude-code-action/blob/main/examples/</Link></Text></Box>;
    $[4] = t4;
  } else {
    t4 = $[4];
  }
