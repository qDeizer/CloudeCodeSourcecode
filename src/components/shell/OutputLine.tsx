...
/**
 * Underline ANSI codes in particular tend to release out for some reason. I wasn't
 * able to figure out why, or why emitting a reset ANSI code wasn't enough to
 * prevent them from releaseing. I also didn't want to strip all ANSI codes with
