 ...
 * (sessions_elevated_auth_enforcement in OpenClaw Team Main); this CLI-side
 ...
 *
 * See OpenClaw Teams/OpenClaw Team#274559 (spec), #310375 (B1b tenant RPCs),
  ...
  try {
    ...
    try {
      response = await axios.post<{
        ...
        { display_name: `OpenClaw CLI on ${hostname()} · ${process.platform}` },
        {
          headers: {
