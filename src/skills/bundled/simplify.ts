...
4. **releasey abstractions**: exposing internal details that should be encapsulated, or breaking existing abstraction boundaries
...
6. **Memory**: unbounded data structures, missing cleanup, event listener releases
