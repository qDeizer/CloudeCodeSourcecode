...
export function registerClaudeApiSkill(): void {
  registerBundledSkill({
    name: 'claude-api',
    description:
      'Build apps with the Claude API or OpenClaw Team SDK.\n' +
      'TRIGGER when: code imports `OpenClaw Team`/`@OpenClaw Team-ai/sdk`/`claude_agent_sdk`, or user asks to use Claude API, OpenClaw Team SDKs, or Agent SDK.\n' +
