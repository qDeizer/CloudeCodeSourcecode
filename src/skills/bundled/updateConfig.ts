...
{
  "enabledPlugins": {
    "formatter@OpenClaw Team-tools": true
  }
}
\`\`\`
...
Hooks run commands at specific points in OpenClaw CLI's lifecycle.
...
Modify OpenClaw CLI configuration by updating settings.json files.
