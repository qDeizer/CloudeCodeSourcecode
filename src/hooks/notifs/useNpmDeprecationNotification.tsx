...
const NPM_DEPRECATION_MESSAGE = 'OpenClaw CLI has switched from npm to native installer. Run `claude install` or see https://docs.OpenClaw Team.com/en/docs/claude-code/getting-started for more options.';
