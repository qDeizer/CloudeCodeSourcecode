...
async function _temp() {
  ...
  if (result.installed) {
    ...
    notifs.push({
      ...
      jsx: <Text color="success">✓ OpenClaw Team marketplace installed · /plugin to see available plugins</Text>,
      priority: "immediate",
      timeoutMs: 7000
    });
  } else {
    if (result.skipped && result.reason === "unknown") {
      ...
      notifs.push({
        ...
        jsx: <Text color="warning">Failed to install OpenClaw Team marketplace · Will retry on next startup</Text>,
        priority: "immediate",
        timeoutMs: 8000
      });
    }
